...
def main():
	...
	try:
		...
		while True:
			...
			current_amp[4] = round(((1.49 - (mcp_analog[4] * (3 / 930))) / 0.066), 2)
			current_amp[5] = round(((1.49 - (mcp_analog[4] * (3 / 916))) / 0.066), 2)
			current_amp[6] = round(((1.49 - (mcp_analog[4] * (3 / 922))) / 0.066), 2)
